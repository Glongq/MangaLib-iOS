...
struct MangaCatalogView: View {
    ...
    var body: some View {
        NavigationStack(path: $navPath) {
            ...
            // .large — эталон теперь App Store (вкладки Сегодня/Игры/
            // Приложения): в покое крупный заголовок без фона, при первом
            // скролле плавно проявляется системный блюр (iOS 26 —
            // scrollEdgeEffectStyle, включён по умолчанию, ничего доп.
            // включать не нужно) и заголовок схлопывается в маленький.
