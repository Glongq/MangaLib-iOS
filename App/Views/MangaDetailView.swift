...
struct MangaDetailView: View {
    ...
    var body: some View {
        ...
        // Прозрачный, но РЕАЛЬНО существующий пустой системный бар — иначе
        // pop на экран с .searchable() просвечивает полем поиска сквозь
        // карточку (и на свайпе, и на тапе). Полная история/почему без
        // ToolbarItem — см. transparentSystemNavigationBar() в
        // App/InteractivePopGesture.swift.
    ...
    /// см. историю решения у transparentSystemNavigationBar() в body), поэтому
    /// не уезжают при скролле независимо от способа входа на экран. Обе — в ОДНОЙ
