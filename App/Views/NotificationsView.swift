...
struct NotificationsView: View {
    ...
    private var list: some View {
        ScrollView {
            ...
            // 16→12 — тот же эталон отступа от углов, что и в Закладках/
            // Истории (см. BookmarksView.titlesList/HistoryView.list) — по
            // прямой просьбе выровнять, раньше здесь было больше, чем везде.
            .padding(.horizontal, 12)
            // 4→12+56: 12 — та же база, что и в Закладках (см. там же), плюс
            // 56 — компенсация за отсутствующую здесь строку поиска (у
            // Закладок есть .searchable() под большим заголовком — своя
            // дополнительная высота под ним, здесь поиска нет и не должно
            // быть, см. комментарий у content), иначе первая карточка
            // визуально начиналась выше, чем в Закладках, при одинаковом
            // "внутреннем" отступе. Число подобрано под типичную высоту
            // системной пилюли поиска — при необходимости можно
            // скорректировать на реальном устройстве.
            .padding(.top, 12 + 56)
